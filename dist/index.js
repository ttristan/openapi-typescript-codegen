...
const postProcessServiceOperations = (service, options) => {
    ...
    return service.operations.map(operation => {
        ...
        if (options === null || options === void 0 ? void 0 : options.useJsonld) {
...
const postProcessService = (service, options) => {
    const clone = { ...service };
...
var templateClient = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "type HttpRequestConstructor = new (config: OpenAPIConfig) => BaseHttpRequest;\n\nexport class "
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias3,lookupProperty(depth0,"services"),{"name":"each","hash":{},"fn":container.program(14, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":76,"column":2},"end":{"line":78,"column":11}}})) != null ? stack1 : "")
    + "	}\n}\n";
  ...
  return "		this."
    + ((stack1 = lookupProperty(helpers,"camelCase").call(depth0 != null ? depth0 : (container.nullContext || {}),lookupProperty(depth0,"name"),{"name":"camelCase","hash":{},"data":data,"loc":{"start":{"line":77,"column":7},"end":{"line":77,"column":27}}})) != null ? stack1 : "")
    + " = new "
    + ((stack1 = alias2(alias1(depth0, "name", {"start":{"line":77,"column":37},"end":{"line":77,"column":41}} ), depth0)) != null ? stack1 : "")
    + ((stack1 = alias2(alias1(lookupProperty(data,"root"), "postfix", {"start":{"line":77,"column":47},"end":{"line":77,"column":60}} ), depth0)) != null ? stack1 : "")
    + "(this.request);\n";
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"header"),depth0,{"name":"header","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + "\n"
    + ((stack1 = lookupProperty(helpers,"equals").call(alias1,lookupProperty(lookupProperty(data,"root"),"httpClient"),"angular",{"name":"equals","hash":{},"fn":container.program(8, data, 0),"inverse":container.program(11, data, 0),"data":data,"loc":{"start":{"line":23,"column":0},"end":{"line":81,"column":11}}})) != null ? stack1 : "");
 ...
 * @param clientName Custom client class name
 */
const writeClientServices = async (services, templates, outputPath, httpClient, useUnionTypes, useJsonld, useOptions, indent, postfix, clientName) => {
 ...
 * @param request Path to custom request file
 */
const writeClient = async (client, templates, output, httpClient, useOptions, useUnionTypes, useJsonld, exportCore, exportServices, exportModels, exportSchemas, indent, postfix, clientName, request) => {
    ...
    if (exportServices) {
        ...
        await writeClientServices(client.services, templates, outputPathServices, httpClient, useUnionTypes, useJsonld, useOptions, indent, postfix, clientName);
    }
    if (exportSchemas) {
 ...
 */
const generate = async ({ input, output, httpClient = exports.HttpClient.FETCH, clientName, useOptions = false, useUnionTypes = false, useJsonld = false, exportCore = true, exportServices = true, exportModels = true, exportSchemas = false, indent = exports.Indent.SPACE_4, postfix = 'Service', request, write = true, }) => {
    ...
    switch (openApiVersion) {
        case OpenApiVersion.V2: {
            ...
            if (!write)
                break;
            await writeClient(clientFinal, templates, output, httpClient, useOptions, useUnionTypes, useJsonld, exportCore, exportServices, exportModels, exportSchemas, indent, postfix, clientName, request);
            break;
        }
